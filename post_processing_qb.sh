...
echo "------------------------------------------------------------------------"
python plot_k_sweep.py -f $dctcpf/k1.txt $tcpecnf/k1.txt -l dctcp tcpecn -o $dctcpf/k1_sweep_comparison.png
python plot_k_sweep.py -f $dctcpf/k2.txt $tcpecnf/k2.txt -l dctcp tcpecn -o $dctcpf/k2_sweep_comparison.png
python plot_k_sweep.py -f $dctcpf/k3.txt $tcpecnf/k3.txt -l dctcp tcpecn -o $dctcpf/k3_sweep_comparison.png
python plot_k_sweep.py -f $dctcpf/k4.txt $tcpecnf/k4.txt -l dctcp tcpecn -o $dctcpf/k4_sweep_comparison.png
